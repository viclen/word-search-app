...
public class LetterTile extends Tile {
    ...
    public LetterTile(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LetterTile(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @SuppressWarnings("unused")
    public LetterTile(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
